...
export const ExtensionDelayMessage = {
    name: 'DelayMessage',
    type: 'response',
    match: ({ trace }) => trace.type === 'ext_delay_message' || trace.payload.name === 'ext_delay_message',
    render: ({ trace, element }) => {
        const { message } = trace.payload || 'We are getting to work, please give us a bit to find your answer.'
